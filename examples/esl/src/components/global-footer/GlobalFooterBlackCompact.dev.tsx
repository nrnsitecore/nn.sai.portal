...
export const GlobalFooterBlackCompact: React.FC<GlobalFooterProps> = (props) => {
              ...
              <div>
                ...
                <div>
                  <Text
                    ...
                    className="font-heading mb-10 text-pretty text-3xl font-semibold tracking-tight antialiased"
                  />
                  {/* Navigation links */}
                </div>
  ...
  return <NoDataFallback componentName="Global Footer - Black Compact" />;
};
