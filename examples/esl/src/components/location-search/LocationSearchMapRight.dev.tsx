...
export const LocationSearchMapRight = (props: LocationSearchProps) => {
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8  ">
          {title?.jsonValue && (
            <AnimatedSection
              ...
              reducedMotion={prefersReducedMotion}
            >
              <Text tag="h2" className="mb-4" field={title?.jsonValue} />
            </AnimatedSection>
          )}
          <AnimatedSection
            direction="up"
  ...
  return <NoDataFallback componentName="LocationSearchMapRight" />;
};
