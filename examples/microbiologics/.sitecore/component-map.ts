...
import * as MicroPortal from 'src/components/MicroPortal';
...
import * as useAddToCartEvent from 'src/components/product-detail/useAddToCartEvent';
...
import * as productcarouselfields from 'src/components/product-carousel/product-carousel.fields';
...
import * as ArticleHeaderCarddev from 'src/components/article-header/ArticleHeaderCard.dev';
...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['MicroPortal', { ...MicroPortal, componentType: 'client' }],
  ...
  ['useIdentifyDemoPersona', { ...useIdentifyDemoPersona, componentType: 'client' }],
  ...
  ['useAddToCartEvent', { ...useAddToCartEvent, componentType: 'client' }],
  ...
  ['ArticleHeaderCard', { ...ArticleHeaderCarddev }],
