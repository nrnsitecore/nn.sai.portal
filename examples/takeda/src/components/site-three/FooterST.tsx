...
export const Default = (props: FooterSTProps) => {
  return (
    ...
    >
      ...
      <div className="border-t border-white/15 my-12 lg:my-16"></div>
      <div className="container mx-auto px-4">
...
export const LogoLeft = (props: FooterSTProps) => {
  return (
    ...
    >
      ...
      <div className="border-t border-white/15 mt-12 lg:mt-16"></div>
    </section>
  );
};
...
export const LogoRight = (props: FooterSTProps) => {
  return (
    <section
      ...
      data-class-change
    >
      <div className="border-t border-white/15 mb-12 lg:mb-16"></div>
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2">
